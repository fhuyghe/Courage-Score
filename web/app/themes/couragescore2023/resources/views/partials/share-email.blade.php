	...
	<div class="p-single__form">
		<div class="ak-form">
			<div id="ak-fieldbox-user_custom_message" class="col-xs-12">
				<div class="text" style="display: block; padding: 20px;"><?php _e('Thank you for sharing your thoughts with your legislator. Close this window to return to <a href="https://www.couragescore.org">CourageScore.org', 'sage');?></div>
			</div>
		</div>
